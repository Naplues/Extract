...
public class XMLHandler {
    ...
    public static void generateXML(Template template, String filePath) {
        ...
        for (References referencesTemplate : referencesTemplateList) {
            ...
            Element refAuthorList;
            if (referencesTemplate.getType().equals("journal"))
                refAuthorList = refBody.addElement("BibArticle").addText("");
            else refAuthorList = refBody.addElement("BibBook").addText("");
            ...
            if (referencesTemplate.getType().equals("journal")) {
                ...
                refAuthorList.addElement("JournalTitle").addText(referencesTemplate.getJournalName());
                refAuthorList.addElement("VolumeID").addText(referencesTemplate.getVolume());
                ...
                refAuthorList.addElement("BookTitle").addText(referencesTemplate.getReferencesarticleTitle());
                refAuthorList.addElement("PublisherName").addText(referencesTemplate.getPublisherName());
                refAuthorList.addElement("PublisherLocation").addText(referencesTemplate.getPublisherLocation());
            }
